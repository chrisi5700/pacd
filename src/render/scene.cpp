...
std::vector<DirectionalLight> default_lights()
{
	return {
		DirectionalLight{
			.direction = normalize(Vec3{-0.5F, -0.9F, -0.4F}), .color = {1.0F, 0.98F, 0.94F}, .intensity = 1.0F},
		DirectionalLight{
			.direction = normalize(Vec3{0.6F, -0.2F, 0.5F}), .color = {0.35F, 0.40F, 0.50F}, .intensity = 1.0F},
	};
}
